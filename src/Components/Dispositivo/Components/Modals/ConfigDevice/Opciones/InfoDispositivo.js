...
const InfoDispositivo = ({dataDis}) => {
    ...
    return (
        <s.Contenedor>
            ...
            <s.Container>
                <s.InputGroup>
                    <s.Label>IMEI: {(dataDis.imei).replace((dataDis.imei).substr(2,11), '***********')}</s.Label>
                </s.InputGroup>
                <s.InputGroup>
                    <s.Label>Tipo: {dataDis.type}</s.Label>
                </s.InputGroup>
            </s.Container>
            <s.Container>
                <s.InputGroup>
            ...
            <s.Container>
                <s.InputGroup>
                    <s.Label>Tiempo Online: {Fecha(dataDis.serverTime)}</s.Label>
                </s.InputGroup>
                <s.InputGroup>
            ...
            <s.Container>
                <s.InputGroup>
                    <s.Label>Última Actualización: {Fecha(dataDis.lasTime)}</s.Label>
                </s.InputGroup>
            </s.Container>
            <s.Container>
                <s.InputGroup>
            ...
            <s.InputGroupTextArea>
                    ...
                    <s.TextArea>{dataDis.observation}</s.TextArea>
            </s.InputGroupTextArea>
        </s.Contenedor>
    )
}
